...
exports.SystemApiResponseProcessor = exports.SystemApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var SystemApiRequestFactory = (function (_super) {
    __extends(SystemApiRequestFactory, _super);
    function SystemApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SystemApiRequestFactory.prototype.checkServer = function (_options) {
        var _a, _b, _c;
    ...
    SystemApiRequestFactory.prototype.getServerCertificate = function (_options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
...
exports.SystemApiRequestFactory = SystemApiRequestFactory;
var SystemApiResponseProcessor = (function () {
    function SystemApiResponseProcessor() {
    }
    SystemApiResponseProcessor.prototype.checkServer = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SystemApiResponseProcessor.prototype.getServerCertificate = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
...
exports.SystemApiResponseProcessor = SystemApiResponseProcessor;
